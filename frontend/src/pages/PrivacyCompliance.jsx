        ...
        <Spotlight className="min-h-full">
            ...
            <div className="relative z-10 max-w-[1200px] mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-white tracking-tight mb-1">Privacy & Data Governance</h1>
                    <p className="text-xs font-mono text-slate-500">Transparent data practices · Privacy-by-design architecture</p>
                </div>
                ...
                <div className="hud-card p-6 mb-8 border-emerald-500/10">
                    <div className="flex items-center gap-3 mb-3">
                        ...
                        <span className="text-sm font-semibold text-white">Privacy-First Approach</span>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                    <div className="hud-card p-5">
                        ...
                        <div className="text-3xl font-mono font-bold text-white mb-3">{cameraRooms.length}</div>
                        <div className="space-y-1.5">
                            {cameraRooms.map(room => (
                                <div key={room.id} className="flex items-center gap-2 py-1.5 px-2 bg-white/[0.01] rounded-md">
                                    <div className="w-1 h-1 rounded-full bg-purple-400" />
                                    <span className="text-[10px] font-mono text-slate-400">{room.name}</span>
                                </div>
                            ))}
                        </div>
                    </div>
                    <div className="hud-card p-5">
                        ...
                        <div className="text-3xl font-mono font-bold text-white mb-3">{nonCameraRooms.length}</div>
                        <div className="space-y-1.5">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        {[
                            ...
                            <motion.div key={i} className="bg-white/[0.01] border border-white/[0.03] rounded-md p-3"
                                ...
                                <p className="text-[10px] font-mono text-slate-600 leading-relaxed">{p.desc}</p>
                            </motion.div>
                        ))}
                    </div>
                </div>
                ...
                <div className="grid grid-cols-4 gap-3 mb-8">
                    {[
                        ...
                        <div key={i} className="hud-card p-4 text-center">
                            ...
                            <div className="text-[9px] font-mono text-slate-600">{std.s}</div>
                ...
                <div className="hud-card p-5 text-center">
                    <div className="text-sm font-semibold text-white mb-2">Privacy Team Available</div>
                    <p className="text-[10px] font-mono text-slate-500 mb-3">Questions about data handling or compliance?</p>
