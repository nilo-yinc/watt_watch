        ...
        <Spotlight className="min-h-full">
            ...
            <div className="relative z-10 max-w-[1400px] mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-[var(--ww-text-1)] tracking-tight mb-1">Energy Analytics</h1>
                    <p className="text-xs font-mono text-[var(--ww-text-3)]">Performance metrics and consumption trends</p>
                </div>
                ...
                <div className="grid grid-cols-3 gap-3 mb-8">
                    {[
                        ...
                        <motion.div key={i} className="hud-card p-5" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.06 }}>
                            ...
                            <div className="text-[10px] font-mono text-[var(--ww-text-muted)] mt-1">{kpi.unit}</div>
                ...
                <div className="hud-card p-5 mb-6">
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[9px] font-mono text-[var(--ww-text-muted)]">kWh saved</span>
                        </div>
                    </div>
                        ...
                        {savedOverTime.map((data, i) => {
                            ...
                            return (
                                <div key={i} className="flex-1 flex flex-col items-center gap-2 group">
                                    ...
                                    <span className="text-[8px] font-mono text-[var(--ww-text-muted)] -rotate-45 origin-top-left whitespace-nowrap">
                            ...
                            return (
                                <motion.div key={i} initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3 + i * 0.04 }}>
                                    <div className="flex items-center justify-between mb-1">
                                        <span className="text-[10px] font-mono text-[var(--ww-text-2)]">{data.room}</span>
                                        <span className="text-xs font-mono font-bold text-[var(--ww-text-1)]">{data.waste} <span className="text-[var(--ww-text-muted)]">kWh</span></span>
                                    </div>
                ...
                <div className="grid grid-cols-3 gap-3">
                    {[
                        ...
                        <div key={i} className="hud-card p-4">
                            ...
                            <p className="text-[10px] font-mono text-[var(--ww-text-3)] leading-relaxed">{insight.desc}</p>
                        </div>
                    ))}
                </div>
            </div>
